...
def predict(
    ...
    #project_id="automlname-id"
    # compute_region = 'COMPUTE_REGION_HERE'
    #compute_region = 'us-central1'
    # model_id = 'MODEL_ID_HERE'
    #model_id = 'ICN7153473003916430375'
    # file_path = '/local/path/to/file'
    #file_path = '/Users/daniel/PyVM-automlname/resources/testing.jpg'
    ...
    for result in response.payload:
        ...
        with open ("resultSave.txt", "a") as f:
            f.write("{}, ".format(result.display_name))
